...
const SPECTRUM_FRAME_WIDTH_PX =
  SPECTRUM_FRAME_PADDING_HORIZONTAL_PX * 2 +
  SPECTRUM_BAR_COUNT * SPECTRUM_BAR_WIDTH_PX +
  (SPECTRUM_BAR_COUNT - 1) * SPECTRUM_BAR_GAP_PX;
const SPECTRUM_FRAME_OFFSET_X_PX = Math.floor((OVERLAY_WIDTH_PX - SPECTRUM_FRAME_WIDTH_PX) / 2);
